...
public class EfCoreTests
{
	...
	public async Task StringConcat()
	{
		...
		var expression = ExpressionTestHelpers.CreateRuleExpression<Employee, bool>(rule);
	...
	public async Task OrderByRule()
	{
		...
		var expression = ExpressionTestHelpers.CreateRuleExpression<Employee, object>(rule);
